...
class Arguments:
    def __init__(self):
        ...
        self.ap.add_argument("-"+c.D_KEY, "--"+c.D_LONG_KEY, action="store_true", help=c.D_HELP)
    ...
    def getArgs(self):
        ...
        return args[c.D_LONG_KEY], args[c.C_LONG_KEY], args[c.I_LONG_KEY], args[c.O_LONG_KEY]